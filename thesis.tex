...
selecting the number of angle cells to be included into a beam pattern in colocated d Multiple-Input Multiple-Output(MIMO) radar \cite{Wang2018}, 
...
Modern radar technologies, such as electronically steerable antennas and waveform diversity, have enabled radars to simultaneously carry out multiple radar functions, including target tracking and search for undetected targets.
